...
setTimeout(function(){
    document.getElementById("m301").style.height=Math.round(window.innerHeight - 110)  + "px"
    document.getElementById("t301").style.height=Math.round(window.innerHeight - 140)  + "px"
    document.getElementById("t302").style.height=Math.round(window.innerHeight - 270)  + "px"

    document.getElementById("t302").addEventListener('keydown', (function(e) {

             self.obsluha(e, e.target)
      }))

    document.getElementById("t302").addEventListener('click', (function(e) {
