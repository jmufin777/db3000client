<template>
  <div>
    ...
    <div
      v-if="VL.length==0"
      style="font-size:200%;font-weight:900"
    >Neni k dispozici zadny VL pro {{IDEFIX_VL}}</div>
    ...
    <div
      ...
      :key="i+'VLX'+IDEFIX_VL"
      class="A4 white"
      style="width:210mm;height:290mm;padding-left:0mm;padding-top:0mm;page-break-after:always"
    >
      <v-card>
        <v-card-text>
          <vl-view :vl="vl"></vl-view>
        </v-card-text>
      </v-card>
...
export default {
  ...
  props: {
    IDEFIX_ITEM: {
      //Asi nejspis ve skutecnosti idefix_vl
      required: false,
      default: 0
    }
  },
  ...
  async mounted() {
    ...
    } else if (!f.isEmpty(self.IDEFIX_ITEM)) {
