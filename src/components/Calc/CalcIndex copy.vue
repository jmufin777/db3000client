<template>
  <div style="height:400px" class="obal">
    ...
    <my-layout>
      ...
      >
        ...
        <div>
          ...
          <work-but-menu
            :ID="ID"
            ref="w1"
            :obrazovka_zak="obrazovka_zak"
            :obrazovka_nab="obrazovka_nab"
          >
            <span slot="tlacitkazakazky">
              ...
              <button
                v-if="MAINMENULAST=='zakazky'"
                class="px-4 tlacitkoMenu elevation-2 hoVer"
                @click="Ulozit('n')"
              >Ulozit jako nabidku</button>
              <button>Aktivni zak {{aktivni_zak}} {{aktivni_zak_short}}</button>
            </span>
          </work-but-menu>
      ...
      <div
        v-if="obrazovka_zak==1 && MAINMENULAST=='zakazky'"
        slot="kalkulace"
      ...
      >
            ...
            >
              <span>
                ...
                <button
                  ...
                  @click="seek_zak_moje=!seek_zak_moje;Seznam('zak')"
                  title="Moje zakazky"
                >
                  <span style="background:#d9e1e7;border-radius:0px 10px 10px 0px;" class="pr-2">
                    <i
                ...
                <button
                  style="border-radius::0px 10px 10px 0px;"
                  @click="search_zak_cislo='';search_zak_cislo2='';search_zak=''
              seek_zak_obchodnik=false;
              seek_zak_firma=false;
              seek_zak_stav=false;
              ;Seznam('zak')"
                  v-if="search_zak_cislo>'' || search_zak>''|| search_zak_cislo2>''"
                >
                  <span style="background:#d9e1e7;border-radius:0px 10px 10px 0px;" class="pr-2">
                    <i
              ...
              <span>
                ...
                <table>
                  <thead>
                    <th>Pocet</th>
                    <th>{{seznam_zak_sum[0].pocet}}</th>
                    <th>Naklad</th>
                    <th>{{seznam_zak_sum[0].naklad}}</th>
                  </thead>
                </table>
              </span>
            </span>
        ...
        <ta-ble3
          v-cloak
          :h="'530px;'+f.pof( Sirka,98.1)+';top:1px'"
          :Sirka="1000"
          :Leva="'0%'"
          :Prava="'0%'"
          :Stred="'100%'"
        ...
        >
          <table slot="head" :style="f.pof(Sirka,98.1)">
            <thead class="c-1 tdline">
              <tr>
                <th :style="f.pof(Sirka,  4.9)">
                  <button @click="vl_viewlist(aktivni_zak)">VL tisk {{vllist.split(',').length}}</button>
                </th>
                <th :style="f.pof(Sirka,  4.82)">
                  ...
                  >
                    <i
                      ...
                      v-if="order_zak=='cislozakazky' && desc_zak==''"
                    ></i>
                    <i
                ...
                <th :style="f.pof(Sirka,  8)">
                  ...
                  >
                    <i
                      class="el-icon-upload2 green--text"
                      v-if="order_zak=='datumzadani' && desc_zak==''"
                    ></i>
                    <i
                      class="el-icon-download orange--text"
                      v-if="order_zak=='datumzadani' && desc_zak>''"
                ...
                <th :style="f.pof(Sirka,  7.5)">
                  ...
                  >
                    <i
                      class="el-icon-upload2 green--text"
                      v-if="order_zak=='time_update' && desc_zak==''"
                    ></i>
                    <i
                      class="el-icon-download orange--text"
                      v-if="order_zak=='time_update' && desc_zak>''"
                ...
                <th :style="f.pof(Sirka,  7.5)">
                  <button type="button" @click="Seznam('zak','','nakladsum')" style="color:#818185">
                    <i
                      class="el-icon-upload2 green--text"
                      v-if="order_zak=='nakladsum' && desc_zak==''"
                    ></i>
                    <i
                      class="el-icon-download orange--text"
                      v-if="order_zak=='nakladsum' && desc_zak>''"
                ...
                <th :style="f.pof(Sirka,  8)" @click="Seznam('zak','','prodejsum')">
                  <button type="button" @click="Seznam('zak','','prodejsum')" style="color:#818185">
                    <i
                      class="el-icon-upload2 green--text"
                      v-if="order_zak=='prodejsum' && desc_zak==''"
                    ></i>
                    <i
                      class="el-icon-download orange--text"
                      v-if="order_zak=='prodejsum' && desc_zak>''"
                ...
                <th :style="f.pof(Sirka,  5.5)">
                  ...
                  >
                    <i
                      class="el-icon-upload2 green--text"
                      v-if="order_zak=='(prodejsum-nakladsum)' && desc_zak==''"
                    ></i>
                    <i
                      class="el-icon-download orange--text"
                      v-if="order_zak=='(prodejsum-nakladsum)' && desc_zak>''"
                    ...
                    <tr style="border:none;">
                      <td style="width:80%;border:none;background:#f7f8fb">
                        ...
                        >
                          <i
                            class="el-icon-upload2 green--text"
                            v-if="order_zak=='obchodnik' && desc_zak==''"
                          ></i>
                          <i
                            class="el-icon-download orange--text"
                            v-if="order_zak=='obchodnik' && desc_zak>''"
          ...
          <table v-cloak slot="body" :style="f.pof(Sirka,98.1)">
            <tbody>
              <tr
                v-for="(polozka,idx) in seznam_zak"
                :key="idx"
                @dblclick="to2Z(polozka);"
                @click="FillFormWait(polozka);aktivni_zak=polozka.idefix"
      ...
      <div
        v-if="obrazovka_zak==2 && MAINMENULAST=='zakazky'"
        slot="kalkulace"
      ...
      >
        ...
        <table style="width:90%;border: solid 1px silver;border-bottom:none">
          ...
          <tbody>
            <tr
              v-for="(polozka2,idx2) in polozky_zak"
              :key="idx2"
              class="hoVer2"
      ...
      ,'nerusit': polozka2.nazev.match(/^Pr.zdn.*$/) && aktivni_polozka_zak!==polozka2.idefix
        ...
        size="medium"   class="green--text"
              ...
              >
                ...
                <!--zakazka!-->
                <div
                  v-else-if="cis_prace.length>=0 && f.isEmpty(polozka2.obsah)"
              ...
              >
                ...
                <div v-if="polozka2.vzor==-999"></div>
                <div
                  v-else-if="polozka2.idefix_dod!=idefix_vlastnik"
                  class="pt-1 pb-1"
                  style="height:39px;width:100%; border-bottom: solid silver 0px;"
                >
                  <div
        ...
        "
                ...
                >{{polozka_zak.zamek }} {{ !f.isEmpty(polozka2.obsah) }}</span>
                <!-- {{polozka2.ks}} -->
              </td>
              <td
                class="rborder pr-2 pl-1"
      ...
      <div
        v-if="obrazovka_nab==1 && MAINMENULAST=='kalkulace'"
        slot="kalkulace"
        style="position:fixed;width:100%;top:24em;overflow:scroll;height:70%"
        id="obalKalkulace"
      >
        ...
        <div class="leva cyan lighten-5" :style="f.pof( Sirka,98)" style="position:relative;">
          ...
          >
            <span>
              ...
              <button
                style="border-radius::0px 10px 10px 0px;"
                @click="seek_nab_moje=!seek_nab_moje;Seznam('nab')"
                title="Moje nabazky"
              >
                <span style="background:#d9e1e7;border-radius:0px 10px 10px 0px;" class="pr-2">
                  <i
              ...
              <button
                style="border-radius::0px 10px 10px 0px;"
                @click="search_nab_cislo='';search_nab_cislo2='';search_nab=''
              seek_nab_obchodnik=false;
              seek_nab_firma=false;
              seek_nab_stav=false;
              ;Seznam('nab')"
                v-if="search_nab_cislo>'' || search_nab>''|| search_nab_cislo2>''"
              >
                <span style="background:#d9e1e7;border-radius:0px 10px 10px 0px;" class="pr-2">
                  <i
                    class="el-icon-close d3 red--text"
            ...
            <span>
              ...
              <table>
                <thead>
                  <th>Pocet</th>
                  <th>{{seznam_nab_sum[0].pocet}}</th>
                  <th>Naklad</th>
                  <th>{{seznam_nab_sum[0].naklad}}</th>
                </thead>
              </table>
            </span>
          </span>
        ...
        <ta-ble3
          v-cloak
          :h="'530px;'+f.pof( Sirka,98.1)+';top:0px'"
          :Sirka="1000"
          :Leva="'0%'"
          :Prava="'0%'"
          :Stred="'100%'"
        ...
        >
              ...
              <tr>
                ...
                <th :style="f.pof(Sirka,  4.82)">
                  ...
                  >
                    <i
                      class="el-icon-upload2 green--text"
                      v-if="order_nab=='cislonabidky' && desc_nab==''"
                    ></i>
                    <i
                      class="el-icon-download orange--text"
                      v-if="order_nab=='cislonabidky' && desc_nab>''"
                ...
                <th :style="f.pof(Sirka,  8)">
                  ...
                  >
                    <i
                      class="el-icon-upload2 green--text"
                      v-if="order_nab=='datumzadani' && desc_nab==''"
                    ></i>
                    <i
                      class="el-icon-download orange--text"
                      v-if="order_nab=='datumzadani' && desc_nab>''"
                ...
                <th :style="f.pof(Sirka,  7.5)">
                  ...
                  >
                    <i
                      class="el-icon-upload2 green--text"
                      v-if="order_nab=='time_update' && desc_nab==''"
                    ></i>
                    <i
                      class="el-icon-download orange--text"
                      v-if="order_nab=='time_update' && desc_nab>''"
                ...
                <th :style="f.pof(Sirka,  7.5)">
                  <button type="button" @click="Seznam('nab','','nakladsum')" style="color:#818185">
                    <i
                      class="el-icon-upload2 green--text"
                      v-if="order_nab=='nakladsum' && desc_nab==''"
                    ></i>
                    <i
                      class="el-icon-download orange--text"
                      v-if="order_nab=='nakladsum' && desc_nab>''"
                ...
                <th :style="f.pof(Sirka,  8)" @click="Seznam('nab','','prodejsum')">
                  <button type="button" @click="Seznam('nab','','prodejsum')" style="color:#818185">
                    <i
                      class="el-icon-upload2 green--text"
                      v-if="order_nab=='prodejsum' && desc_nab==''"
                    ></i>
                    <i
                      class="el-icon-download orange--text"
                      v-if="order_nab=='prodejsum' && desc_nab>''"
                ...
                <th :style="f.pof(Sirka,  5.5)">
                  ...
                  >
                    <i
                      class="el-icon-upload2 green--text"
                      v-if="order_nab=='(prodejsum-nakladsum)' && desc_nab==''"
                    ></i>
                    <i
                      class="el-icon-download orange--text"
                      v-if="order_nab=='(prodejsum-nakladsum)' && desc_nab>''"
                    ...
                    <tr style="border:none;">
                      <td style="width:80%;border:none;background:#f7f8fb">
                        ...
                        >
                          <i
                            class="el-icon-upload2 green--text"
                            v-if="order_nab=='obchodnik' && desc_nab==''"
                          ></i>
                          <i
                            class="el-icon-download orange--text"
                            v-if="order_nab=='obchodnik' && desc_nab>''"
          ...
          <table slot="body" :style="f.pof(Sirka,98.1)">
            <tbody>
              <tr
                v-for="(polozka,idx) in seznam_nab"
                :key="idx"
                @dblclick="to2N(polozka);"
                @click="FillFormWait(polozka);aktivni_nab=polozka.idefix"
                style="cursor:pointer"
      ...
      <div
        v-if="obrazovka_nab==2 && MAINMENULAST=='kalkulace'"
        slot="kalkulace"
        style="position:fixed;width:100%;top:24em;overflow:scroll;height:70%"
        id="obalKalkulace"
        class="stred"
      >
        ...
        >
          ...
          <tbody>
            <tr
              v-for="(polozka2,idx2) in polozky_nab"
              :key="idx2"
      ...
      >
        <div class="leva pt-0 pb-2">
          ...
          <button
            class="px-4 tlacitkoMenu elevation-2 hoVer"
            v-if="MAINMENULAST=='kalkulace' && !f.isEmpty(polozka_nab)"
            @click="to2N(polozka_nab)"
          >2N</button>
          <button
            class="px-4 tlacitkoMenu elevation-2 hoVer"
            v-if="MAINMENULAST=='zakazky' && !f.isEmpty(polozka_zak)"
            @click="to2Z(polozka_zak)"
          >2Z</button>
        ...
        <div v-if="false" style="position:fixed; top:30em;right:30%;opacity:0.5">
          <span
            v-if="MAINMENULAST=='zakazky'   && obrazovka_zak == 3"
            style="color:red; font-size:10em"
          >3Z</span>
          <span
            v-if="MAINMENULAST=='kalkulace' && obrazovka_nab == 3"
            style="color:red; font-size:10em"
          >3N</span>
        </div>
        ...
        <div v-cloak v-for="idxK in 1" :key="'x'+idxK" slot="kalkulace">
          ...
          <work
            ...
            :Poradi="0"
            v-for="(iKalk ,iK) in aKalkulace"
            :key="iK"
            class="myska"
          >
            <span v-if="iK==0" slot="tlacitka" style="position:relative;left:4px">
              <!-- nejsou zadne radky - zakladam uplne novou kalkulaci ||  IDEFIXACTIVE==0 -->
              <work-but
                v-cloak
              ...
              <!-- Aktivni - rozalena radka && e.idefix==IDEFIXACTIVE -->
              <work-but
                v-cloak
                v-for="(aBefore1,iBefore1 ) in aKalkBefore.filter(e=>{return e.active==true   })"
    ...
    <hr>
      ...
      <div
        v-if="(obrazovka_nab==3 && MAINMENULAST=='kalkulace')|| (MAINMENULAST=='zakazky' && obrazovka_zak==3)"
              ...
              <v-card style="width:60%;float:left">
                ...
                <v-card-text>
                  <table>
                    <tr>
                      <td
                        v-for="(Sloupec, idSloupce) in iK.sloupecid"
                        :key="idSloupce"
                      >{{Sloupec.type}}</td>
                    </tr>
                  </table>
          ...
          <div v-for="(iK,i) in aKalkulace" :key="i" style="width:100%;">
            ...
            <div style="float:left">
              <v-card>
                ...
                <v-card-text>
                  <div class="white" style="float:left">Rozmer {{Kalkulace[i].data.txtFormat}}</div>
...
export default {
  ...
  watch: {
    cTable: async function() {
      ...
      queryKalk.getTemplatesUser(self.cTable).then(res => {
        ...
        if (self.Zacatek > 0) {
          ...
          if (self.MAINMENULAST == "kalkulace" && self.IDEFIXACTIVE_NAB > 0) {
            ...
            self.setRozbalit(self.IDEFIXACTIVE).then(() => {
              f.sleep(1500).then(() => {
                self.setIdefixActive();
                //f.Alert('Rozbalim Za')
              });
    ...
    aKalkBefore: function(a) {
      ...
      var neco = self.aKalkBefore.filter(e => {
  ...
  async created() {
    ...
    eventBus.$on("IDEFIX_VLIST", server => {
      ...
      let route = this.$router.resolve({
        name: "vl",
        params: { id: self.vllist }
      });
      // let route = this.$router.resolve('/link/to/page'); // This also works.
      window.open(
        route.href,
        "vl_" + self.aktivni_zak,
    ...
    await eventBus.$on("SAVETEMPLATE", server => {
      ...
      await eventBus.$on("SAVEZAZNAM", server => {
        ...
        if (server.data.nazev == "") {
          ...
          if (server.idefix != self.IDEFIXACTIVE) {
          ...
          } else if (server.idefix == self.IDEFIXACTIVE && server.idefix > 0) {
            ...
            SaveKalkulkace = true;
            //queryKalk.VkladUser(server.data, self.aKalkulace, self.cTable, "", false, server.idefix, SaveKalkulkace )
          } else if (server.idefix == 0 && self.IDEFIXACTIVE == 0) {
      ...
      eventBus.$on("MenuHlavni", server => {
        ...
        if (server.key == 1999) {
          ...
          if (self.MAINMENULAST == server.item) {
            ...
            } else if (self.MAINMENULAST == "zakazky") {
  ...
  methods: {
        ...
        if (await self.otazka(`Odeslat ${nRet} zbyvajicich VL ?`)) {
          await f
            ...
            .then(() => {
              ...
              Q.post(
                self.idefix,
                `select vl_set(idefix_zak(${self.aktivni_zak}),-1)`
              ); //uklid
              f.log(
                "VL ALL 4A ",
                `select vl_set(idefix_zak(${self.aktivni_zak}),-1)`
    ...
    async ZalozitZobrazit(polozka2) {
      ...
      if (polozka2.nazev.match(/^Pr.zdn.*$/)) {
        polozka2.nazev = "Nova";
        self.ZmenPolozku(
          self.MAINMENULAST == "zakazky" ? "zak" : "nab",
          polozka2
        );
      }
    ...
    async copyRadek(ifx) {
      ...
      } else if (self.MAINMENULAST == "kalkulace") {
        ceho = "nab";
     ...
     ,user_update_idefix=${self.idefix},idefix= nextval('list2_seq'::regclass),id=nextval('zak_t_items_id_seq'::regclass),status=0`;
      ...
      if (self.MAINMENULAST == "zakazky") {
        ...
        await Q.post(
          self.idefix,
          `create table  ${self.cTable} without oids as select * from ${ceho}_t_items where idefix_zak=${ifx_aktivni}`
        );
        await Q.post(
          self.idefix,
          `alter table  ${self.cTable}  alter column id set default nextval('${self.cTable}_seq'::regclass ) `
        );
        await Q.post(
          self.idefix,
          `alter table  ${self.cTable}  alter column idefix set default  nextval('list2_seq'::regclass) `
        );
    ...
    async addPol(ceho = "zak", idefix_zaknab = -1) {
      ...
      addPol.forEach(el => {
        if (ceho == "zak") {
          ...
          if (
            _.findIndex(self.polozky_zak, function(o) {
              return o.vzor == -999;
            }) == -1
          ) {
          ...
          if (
            _.findIndex(self.polozky_nab, function(o) {
              return o.vzor == -999;
            }) == -1
          ) {
            addEmpty = f.Jparse(el);
    ...
    async to1Z() {
      ...
      if (self.MAINMENULAST == "zakazky" && self.status_zak == 1) {
        this.$confirm(
          "Zrusit zakladni nove zakazky ? " + self.aktivni_zak,
          "",
          {
            distinguishCancelAndClose: true,
            confirmButtonText: "Ano?",
    ...
    async to3N(polozka, odkud = 1) {
      ...
      if (odkud == 1 && self.aktivni_polozka_nab > 0) {
    ...
    async to3Z(polozka, odkud = 1) {
      ...
      if (odkud == 1 && self.aktivni_polozka_zak > 0) {
        //Polozka vybarna, pristup pres tlacitko nahore
    ...
    ;`;
      ...
      this.$notify({
        title: `Kod kliku: ${kod} ${self.MAINMENULAST}`,
        message: `Status kliku : Zak:   ${self.status_zak} Nab:  ${self.status_nab} `,
        type: "success",
        offset: 100,
        duration: 2000
      });
      ...
      if (true || self.status_zak == 2) {
        if (self.status_nab == 2 && self.MAINMENULAST == "kalkulace") {
      ...
      if (true || self.status == 1) {
        ...
        } else if (self.status_zak == 1 && self.MAINMENULAST == "zakazky") {
        ...
        self.cis_prace_vlastnik = self.cis_prace.filter(el => {
          return (
            _.findIndex(el.dod_seznam, function(o) {
              return o * 1 == self.idefix_vlastnik * 1;
            }) > -1
          );
          // return true
        });
...
*/
      ...
      if (ceho == "zak") {
        if (ev == 1) {
          ...
          if (self.polozky_zak.length > 0) {
            self.aktivni_polozka_zak =
              self.polozky_zak[self.polozky_zak.length - 1].idefix;
          }
        ...
        if (ev == 1) {
          ...
          if (self.polozky_nab.length > 0) {
            self.aktivni_polozka_nab =
              self.polozky_nab[self.polozky_nab.length - 1].idefix;
          }
        }
    ...
    async Seznam(ceho = "zak", where = "", orderby = "", add = false) {
      ...
      if (ceho == "zak") {
        ...
        if (f.isEmpty(orderby) && self.order_zak > "") {
          ...
          desc = self.desc_zak;
        } else if (self.order_zak == orderby) {
          if (self.desc_zak == "") {
            self.desc_zak = "desc";
          } else {
            self.desc_zak = "";
      ...
      if (ceho == "nab") {
        ...
        if (f.isEmpty(orderby) && self.order_nab > "") {
          ...
          desc = self.desc_nab;
        } else if (self.order_nab == orderby) {
          if (self.desc_nab == "") {
            self.desc_nab = "desc";
          } else {
            self.desc_nab = "";
      ...
      } else if (add && self.search_nab_cislo2 > 0 && ceho == "nab") {
        cislo = "cislonabidky";
        qadd = `select  *
                    , idefix2fullname(idefix_obchodnik) as obchodnik
                    , idefix2fullname(idefix_produkce)  as produkce
      ...
      if (self._IsObchod) {
        ...
        // f.Alert2(qsubSum)
      } else if (!self._IsObchod && self._IsVedeni) {
                  ...
                  self
                    ...
                    .then(() => {
                      ...
                      Q.all(
                        ...
                        Q.all(
                          self.idefix,
                          `select *,0 as vse,idefix_vl(idefix) as idefix_vl from zak_t_items where idefix_zak =${self.aktivni_zak} order by idefix `
                        ).then(res => {
                  ...
                  self
                    ...
                    .then(() => {
                      ...
                      Q.all(
                        ...
                        Q.all(
                          self.idefix,
                          `select *,0 as vse from nab_t_items where idefix_nab =${self.aktivni_nab} order by idefix `
                        ).then(res => {
    ...
    async addVL() {
      ...
      setTimeout(function() {
        ...
        self
          .saveZaznam({ idefix: self.IDEFIXACTIVE, data: dataRadka }, 3)
          .then(res => {
            //f.Alert('Vlozeno')
          });
    ...
    async setVLOld(idefix) {
      ...
      var nK = await queryKalk.getTemplateUserIdefix(idefix, self.cTable); //Aktualni kalulkulace
