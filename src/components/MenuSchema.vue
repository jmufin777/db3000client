              ...
              <div v-if="xMy0[10].length>0 || xMy0[9]=='Group'" class="g0">
                ...
                <li v-for="(xMy1, i1) in xMy0[10]" :key="'x'+i1"  >
                  ...
                  <div v-if="xMy1[10].length>0" class="g1 elevation-18">
                    1 g - {{i1+1}} >> {{ xMy1[10].length==0 }}
                    i - {{xMy1[0]}} <v-icon>{{ xMy1[1] }}</v-icon>
