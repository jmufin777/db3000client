<template>
<el-row id="m811" style="overflow:scroll"  class="pa-2" >
  <el-col :span="24">
  <el-row  :gutter="100">
...
<div style="height:100%;overflow:scroll" class="mt-0" id="t812">
  <form id="f811">
  ...
  >
      ...
      v-show="col.props.visible=='yes'"
      >
      <div :id="'d812_r_'+irow+'_c_'+icol"  class='dcell' >

        <input type="number" v-if="col.type =='number'"
        class=" px-4 cell " :id="'c812_r_'+irow+'_c_'+icol"
    ...
    <el-dropdown v-else-if="col.type=='selectone2'">
      <span class="el-dropdown-link">
        ...
        class="white px-4 cell seda" :id="'c812_r_'+irow+'_c_'+icol"
        v-bind:class="{seda: irow % 2 ==0 , bila:  irow % 2 >0}"
        :value="item[col.id]" style="width:100%;border:none;height:100%" readonly
...
setTimeout(function(){
  ...
  if (document.getElementById('list-stroj'))  {
    tmpObj = document.getElementById('list-stroj')
    var s1 = 20
    var s2 = 50
    var s3 = 100
  ...
  destroyed () {
    if (document.getElementById("t812")){
        ///nejde
      //document.getElementById("t812").removeEventListener(document.getElementById("t812"),'keydown')

    }
    // alert('destos'+document.getElementById("t812"))
  },
  beforeUpdate () {
...
copyLine(nRow) {
   ...
   deleteLine(nRow) {
    ...
    //  return
     ...
     if (eof == true) {
       new_id='c812_r_'+(self.list.length -1)+'_c_'+1
     }
     if (top == true) {
...
//       this.$alert(ekeyCode)
   ...
   //return
    if (document.getElementById('search_811') && ekeyCode == 114 ){
       document.getElementById('search_811').focus()
     }
