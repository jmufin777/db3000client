...
<div style="height:100%;overflow:scroll" class="mt-0" :id="'t' + objId2 ">
  ...
  >
      ...
      <div :id="'d342_r_'+irow+'_c_'+icol"  class='dcell' >
        ...
        class=" px-0 cell " :id="'c342_r_'+irow+'_c_'+icol"
       ...
       :value="item[col.id]"  style="width:100%;border:none;height:100%;text-align:left" readonly
        ...
        class="white px-0 cell seda" :id="'c342_r_'+irow+'_c_'+icol"
        v-bind:class="{seda: irow % 2 ==0 , bila:  irow % 2 >0}"
        :value="item[col.id]" style="width:100%;border:none;height:100%" readonly

        min="2007-06-01T08:30" max="2420-06-30T16:30"
        >
  ...
  data () {
    return {
      ...
      minId: 0, //Pro vklad zaporna ID
        ...
        { id: "zkratka", title: "Zkr", cssClasses: "mtd", span: 3, isEdit: true, type: "text" ,props:{visible: 'yes'}},
...
setTimeout(function(){
  ...
  var moduleName='list2-matdostupnost'
