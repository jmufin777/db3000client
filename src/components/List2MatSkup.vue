...
<el-row id="m321" style="overflow:scroll"  class="pa-2" >
  ...
  <el-input prefix-icon="el-icon-search" id="search_321" autofocus clearable size="mini" v-model="search" placeholder="Prohledat tabulku">
  </el-input>
  </el-col>
...
//       this.$alert(ekeyCode)
   ...
   //return
    if (document.getElementById('search_321') && ekeyCode == 114 ){
       document.getElementById('search_321').focus()
     }
